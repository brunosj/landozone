...
<svg xmlns="http://www.w3.org/2000/svg" {width} viewBox="0 0 24 24" {...$$props}
	><g fill="none" stroke="currentColor" stroke-width="1.5"
		><path
			...
			d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12s4.477 10 10 10" /><path
			stroke-linecap="round"
			stroke-linejoin="round"
			d="M13 2.05S16 6 16 12m-5 9.95S8 18 8 12c0-6 3-9.95 3-9.95M2.63 15.5H12m-9.37-7h18.74" /><path
